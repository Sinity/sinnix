...
}:
{
  ...
  # Consolidated programs configuration block
  programs = {
    # --- Bat Config ---
    bat = {
      enable = true;
    ...
    zsh = {
      ...
      # Session variables moved to home.sessionVariables
    ...
    nushell = {
      ...
      environmentVariables = {
        # AI tool configurations (only the unique variables here)
      ...
      # Aliases from config.nu (consistent with zsh aliases)
      shellAliases = {
        # Basic utilities
        c = "clear";
        cat = "bat";
