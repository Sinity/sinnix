...
Help create a new Claude Code skill with proper structure.
...
SEQUENTIAL:
  ...
  → determine scope: user (~/.claude/skills/) or project (.claude/skills/)
...
5. Explain invocation: `/skill-name args`
