...
allowed-tools:
  ...
  - Edit
  - Task
argument-hint: "<target> [--level crate|module|file]"
---

# Interactive Code Analysis

Step-by-step codebase analysis with user steering. Unlike `/swarm analyze` (autonomous parallel), this pauses for input between phases.
