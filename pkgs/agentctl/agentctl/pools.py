"""The declared width of every pueue group, applied to the running daemon.
...
def apply(
    declared: Mapping[str, int], *, wait_seconds: float = DAEMON_WAIT_SECONDS
) -> dict[str, Any]:
