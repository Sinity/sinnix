...
# Agents run until they finish; a coordinator cancels by hand. The value is
# the unit's watchdog, not a budget: a week, so a stuck agent is still
# reaped eventually.
MAX_AGENT_TIMEOUT_SECONDS = 7 * 24 * 3_600
