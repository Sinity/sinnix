...
python3Packages.buildPythonApplication {
  ...
  '';
  meta = {
    description = "Always-on dual-channel (mic + sink-monitor) PipeWire audio capture: Opus archive tier, pw-mon topology stream, Silero VAD index-only lane, pause/gap CLI";
