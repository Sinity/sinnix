...
class GitHubDelivery:
    ...
    def publish(
        self, workspace_id: str, job_id: str, title: str, body: str, packet_job_id: str | None = None
    ) -> dict[str, Any]:
        workspace, project, receipt = self._verified_workspace(workspace_id, job_id, packet_job_id)
    ...
    def land(self, workspace_id: str, job_id: str, packet_job_id: str | None = None) -> dict[str, Any]:
        ...
        _workspace, _project, receipt = self._verified_workspace(workspace_id, job_id, packet_job_id)
    ...
    def _verified_workspace(
        ...
        try:
            ...
            binding = self._binding(record, checkout, workspace) if packet_job_id is not None else None
        ...
        return workspace, project, {
            "ref": packet["artifact_ref"] if packet is not None else f"sinnix://jobs/{job_id}",
            "job_id": job_id,
    ...
    def _binding(
        ...
        if (
            ...
            raise DeliveryError("declared verification lacks an authoritative Beads packet binding")
        return binding
    ...
    def _packet(
        ...
        if (
            ...
            or set(envelope) != {"schema_version", "job_id", "start_head", "final_head", "delivery"}
        ...
        return {
            ...
            "artifact_ref": artifact.get("ref") if isinstance(artifact, Mapping) else f"sinnix://jobs/{job_id}",
        }
