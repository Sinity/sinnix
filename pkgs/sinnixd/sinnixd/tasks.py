...
class TaskService:
    ...
    def _execute(
        ...
        *,
        ...
        # task.list and task.get were deliberately removed: reads go through
        # the task backend CLI (bd) directly; the daemon owns only mutation
        # identity, journaling, reconcile, and the authority-bound snapshot.
