...
def product_source(path: Path, *, max_age_seconds: float = 86400.0) -> Callable[[], dict[str, Any]]:
    def collect() -> dict[str, Any]:
        ...
        if not isinstance(value, dict) or value.get("schema") != "lynchpin-ambient-intelligence-v1":
