...
def test_polylogue_archive_inventory_reports_all_tier_states(tmp_path, monkeypatch) -> None:
    ...
    assert list(states) == ["index.db", "source.db", "embeddings.db", "ops.db", "audit.db", "user.db"]
