...
in
{
  perSystem =
    ...
    let
      ...
      fixture =
        pkgs.runCommand "campaign-consumer-fixture"
          {
            nativeBuildInputs = [
              pkgs.coreutils
              pkgs.python3
