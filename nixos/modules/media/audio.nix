...
let
  cfg = config.sinnix.media.pipewire.enable;
in
{
  options.sinnix.media.pipewire.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
    description = "Enable the PipeWire/WirePlumber audio stack and related desktop tooling.";
  };
