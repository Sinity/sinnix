...
let
  ...
  scriptLinks = [
    ...
    { target = "toggle-scratch"; source = "toggle-scratch"; }
    { target = "combine-files"; source = "combine-files"; }
    { target = "rawlog-capture"; source = "rawlog-capture"; }
    { target = "kitty-grid"; source = "kitty-grid"; }
    { target = "rawlog-loop"; source = "rawlog-loop"; }
    { target = "log-to-knowledgebase"; source = "rawlog"; }
  ];
in
{
