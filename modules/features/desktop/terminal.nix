        ...
        in
        {
          ...
          programs.kitty = {
            ...
            settings = {
              ...
              # cursor_trail is not the cause of kitty's idle memory growth
              # (exonerated by telemetry); kept off while the globally
              # patched kitty build establishes a clean post-fix
              # memory-slope baseline.
              cursor_trail = 0;
