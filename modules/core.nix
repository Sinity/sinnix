  ...
  config = {
    ...
    systemd = {
      tmpfiles.rules = lib.mkAfter [
        ...
        "d ${paths.realmRoot}/reports 0755 ${username} users -"
        "d ${paths.libraryRoot} 0755 ${username} users -"
        "d ${paths.datasetsRoot} 0755 ${username} users -"
        "d ${paths.documentsRoot} 0755 ${username} users -"
        "d ${paths.documentsRoot}/lastpass 0755 ${username} users -"
        "d ${paths.documentsRoot}/lastpass/raw 0755 ${username} users -"
        "d ${paths.activityRoot}/activitywatch 0755 ${username} users -"
        "d ${paths.activityRoot}/activitywatch/raw 0755 ${username} users -"
