  ...
  sinnix.services = {
    ...
    agent-gateway = {
      ...
      tunnel = {
        ...
        # opaque-artifact reads, V2 status, catalog, canonical get, and route preflight.
        approvedManifestHash = "a83a8dc05f0678ac994702b48ec92a71e3f07e7167328bbd7f8832cdecba87e6";
