...
}:
{
  ...
  # Dedicated client key generated by the freshly initialized Termux install.
  # SSH and Mosh use this over Tailscale, providing an emergency shell when
  # local desktop input is unavailable.
  users.users.${config.sinnix.user.name}.openssh.authorizedKeys.keys = [
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIPxwyMS1/M/hxheMcg/E7VQzql/Zdv1/hRfGuKYCtMq3 redmi-note-11@tailscale"
  ];
    ...
    agent-gateway = {
      ...
      endpoints = {
        operator = {
          ...
          approvedManifestHash = "7960deaa209aa29fee1577184efd8dbc1bf640d36f0fd547ee78bf856b6abc95";
        };
      };
    };
