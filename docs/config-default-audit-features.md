...
| `modules/features/dev`                |                     13 files |                         8 | default-on user surface      | Retain. Agent, shell, editor, language, and workbench settings define the workstation contract.                                                                      |
...
| Development       | `default.nix`, `agents/default.nix`, `agents/backends.nix`, `agents/browser.nix`, `agents/client-profiles.nix`, `agents/clis.nix`, `agents/hooks.nix`, `agents/mcp-tools.nix`, `agents/mcp.nix`, `editors.nix`, `git.nix`, `interp-lab.nix`, `languages.nix`, `shell.nix`, `workbench.nix` |
