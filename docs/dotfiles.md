...
|----------------|--------------------------------------------------|-------|
| `audacity/`    | `modules/features/desktop/common-apps/default.nix` (`xdg.configFile`) | UI settings for the audio editor |
...
| `Kvantum/`     | `modules/features/desktop/common-apps/default.nix` (Qt style)          | Kvantum theme synchronized with Stylix |
...
| `qt5ct/`, `qt6ct/` | `modules/features/desktop/common-apps/default.nix` (`xdg.configFile`) | Qt control centre themes |
| `qutebrowser/` | `modules/features/desktop/browser/default.nix` (config + scripts)      | Config, userstyles, userscripts |
...
| `transmission/`| `modules/features/desktop/common-apps/default.nix`                     | GTK client preferences |
| `vscode/`      | `modules/features/dev/vscode.nix` (settings/keybindings/MCP)           | VS Code profile |
| `yazi/`        | `modules/features/desktop/common-apps/default.nix` (keymap/opener)     | File manager bindings |
...
- Waybar: templated CSS/JSON tied to system packages in `modules/features/desktop/waybar/default.nix`.
- Fnott/Clipse/Tofi: configured alongside services inside `modules/features/desktop/fnott/default.nix`,
  `modules/features/desktop/clipse/default.nix`, and `modules/features/desktop/tofi/default.nix`.
